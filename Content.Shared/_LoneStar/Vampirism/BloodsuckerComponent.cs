...
{
    [DataField]
    public EntProtoId Action = "ActionSuckBlood";
    ...
    [DataField("sound")]
    public SoundSpecifier SuckSound = new SoundPathSpecifier("/Audio/Items/drink.ogg");
}

public sealed partial class SuckBloodEvent : EntityTargetActionEvent;
[Serializable, NetSerializable] public sealed partial class SuckBloodDoAfterEvent : SimpleDoAfterEvent;
